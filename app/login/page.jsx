...
function Page() {
  ...
  return (
    <div className=" p-4 bg-[#070706] text-white relative">
      ...
      <div className="flex justify-center w-full">
        <div className="flex flex-col items-center border-2 border-slate-800 rounded-2xl w-full max-w-md p-6 bg-black">
          ...
          <p className="mt-4">
            ...
            <Link href="/signup" className="text-[#F26C2B]">
              Sign Up
            </Link>
          </p>
      ...
      <footer className="bg-black w-full text-white py-8 mt-12">
